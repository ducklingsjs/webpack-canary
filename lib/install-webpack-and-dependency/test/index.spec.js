...
describe('installWebpackAndDependency', function() {
  ...
  it('calls yarn install with correct values', function() {
    expect(env.childProcessStub.exec).to.have.been.calledOnce;
    expect(env.childProcessStub.exec).to.have.been.calledWith('yarn add --no-lockfile webpack@2.3.4 raw-loader@1.2.3');
  });
  ...
  describe('when outputted messages on error', function() {
    describe('which contain errors', function() {
      beforeEach(function() {
    ...
    describe('which contain warnings', function() {
      beforeEach(function() {
      ...
      it('does not call the callback with error message', function() {
        expect(env.callbackMock).to.have.been.calledOnce;
